...
@Component({
    selector: 'ej-app',
    templateUrl: './quickaccesstoolbar.component.html',
    providers: [NorthwindService]
})
export class QuickAccessToolbarComponent {
    ...
    groups1 = [{
        ...
        },
        {
            ...
            content: [{
                groups: [{
                    id: 'bold', toolTip: 'Bold', type: 'togglebutton', quickAccessMode: 'toolbar',
                    toggleButtonSettings: { contentType: 'imageonly', defaultText: 'Bold', activeText: 'Bold', defaultPrefixIcon: 'e-ribbon e-icon bold', activePrefixIcon: 'e-ribbon e-icon bold' }
                        ...
                        id: 'italic', toolTip: 'Italic', type: 'togglebutton', quickAccessMode: 'toolbar',
                    ...
                    {
                        id: 'underline', toolTip: 'Underline', type: 'togglebutton', quickAccessMode: 'toolbar',
                        toggleButtonSettings: {
                            contentType: 'imageonly',
