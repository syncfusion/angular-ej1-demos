...
export const appRoutes: Routes = [
  ...
  { path: 'reportviewer', loadChildren: './components/reportviewer/reportviewer.module#ReportViewerModule', data: { category: 'Reporting', name: 'ReportViewer' } },
  { path: 'reportdesigner', loadChildren: './components/reportdesigner/reportdesigner.module#ReportDesignerModule', data: { category: 'Reporting', name: 'ReportDesigner', type: 'preview' } },
