...
import { EJ_REPORTVIEWER_COMPONENTS } from 'ej-angular2/src/ej/reportviewer.component';
import { EJ_REPORTDESIGNER_COMPONENTS } from 'ej-angular2/src/ej/reportdesigner.component';
...
@NgModule({
    ...
    declarations: [EJTemplateDirective, LoggerComponent, EJ_DIALOG_COMPONENTS, EJ_LISTBOX_COMPONENTS, EJ_COMBOBOX_COMPONENTS,
        ...
        EJ_GRID_COMPONENTS, EJ_CIRCULARGAUGE_COMPONENTS, EJ_NUMERICTEXTBOX_COMPONENTS, EJ_WAITINGPOPUP_COMPONENTS, EJ_MENU_COMPONENTS, EJ_REPORTVIEWER_COMPONENTS, EJ_REPORTDESIGNER_COMPONENTS],
    exports: [EJTemplateDirective, LoggerComponent, EJ_DIALOG_COMPONENTS, EJ_LISTBOX_COMPONENTS, EJ_TAB_COMPONENTS, EJ_TOOLBAR_COMPONENTS, EJ_RTE_COMPONENTS,
        ...
        EJ_REPORTVIEWER_COMPONENTS, EJ_REPORTDESIGNER_COMPONENTS]
})
