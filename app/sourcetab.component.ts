...
export class SourceTabComponent {
  ...
  constructor(private _router: Router, private http: Http, private activeroute: ActivatedRoute, private appComp: AppComponent, private titleService: Title) {
  ...
  setChildRoutes(pRoute: string) {
    System.import('./components/' + pRoute + '/' + pRoute + '.module').then((module: any) => {
