...
@Component({
    selector: 'ej-app',
    templateUrl: './radialtree.component.html'
})
        ...
        let data = [
            {
                ...
                'ImageUrl': '/app/content/images/radialtree/Clayton.png', 'IsExpand': 'true', 'RatingColor': '#C34444'
            },
            {
                'Id': 1, 'Name': 'Ana Trujillo', 'Designation': 'Project Manager',
                'ImageUrl': '/app/content/images/radialtree/Thomas.PNG', 'IsExpand': 'false',
                'RatingColor': '#68C2DE', 'ReportingPerson': 'parent'
            },
            {
                'Id': 2, 'Name': 'Lino Rodri', 'Designation': 'Project Manager',
                'ImageUrl': '/app/content/images/radialtree/Robin.PNG', 'IsExpand': 'true',
                'RatingColor': '#68C2DE', 'ReportingPerson': 'parent'
            },
            {
            ...
            },
            {
                ...
                'ImageUrl': '/app/content/images/radialtree/Paul.png', 'IsExpand': 'true',
                'RatingColor': '#68C2DE', 'ReportingPerson': 'parent'
            },
            {
                'Id': 5, 'Name': 'Anto Moreno', 'Designation': 'Project Lead',
                'ImageUrl': '/app/content/images/radialtree/image53.png', 'IsExpand': 'false',
                'RatingColor': '#93B85A', 'ReportingPerson': 1
            },
            {
                'Id': 6, 'Name': 'Elizabeth Roel', 'Designation': 'Project Lead',
                'ImageUrl': '/app/content/images/radialtree/Maria.png', 'IsExpand': 'false',
                'RatingColor': '#93B85A', 'ReportingPerson': 1
            },
            {
                'Id': 7, 'Name': 'Aria Cruz', 'Designation': 'Project Lead',
                'ImageUrl': '/app/content/images/radialtree/Jenny.png', 'IsExpand': 'false',
                'RatingColor': '#93B85A', 'ReportingPerson': 1
            },
            {
                'Id': 8, 'Name': 'Eduardo Roel', 'Designation': 'Project Lead',
                'ImageUrl': '/app/content/images/radialtree/image55.png', 'IsExpand': 'true',
                'RatingColor': '#93B85A', 'ReportingPerson': 1
            },
            {
            ...
            },
            {
                ...
                'ImageUrl': '/app/content/images/radialtree/Thomas.png', 'IsExpand': 'true',
                'RatingColor': '#93B85A', 'ReportingPerson': 2
            },
            {
                'Id': 11, 'Name': 'Nardo Batista', 'Designation': 'Project Lead',
                'ImageUrl': '/app/content/images/radialtree/Maria.PNG', 'IsExpand': 'true',
            ...
            },
            {
                ...
                'ImageUrl': '/app/content/images/radialtree/Clayton.png', 'IsExpand': 'None',
            ...
            },
            {
                ...
                'ImageUrl': '/app/content/images/radialtree/John.png', 'IsExpand': 'None',
                'RatingColor': '#EBB92E', 'ReportingPerson': 90
            },
            {
                'Id': 17, 'Name': 'Matti Kenna', 'Designation': 'Project Lead',
                'ImageUrl': '/app/content/images/radialtree/Jenny.png', 'IsExpand': 'None',
                'RatingColor': '#93B85A', 'ReportingPerson': 4
            },
            {
                    'Id': 18, 'Name': 'Laura Callahan', 'Designation': 'Project Lead',
                    'ImageUrl': '/app/content/images/radialtree/Robin.png', 'IsExpand': 'false',
                    'RatingColor': '#D46E89', 'ReportingPerson': 4
            },
            {
                    'Id': 19, 'Name': 'Simon Roel', 'Designation': 'Project Lead',
                    'ImageUrl': '/app/content/images/radialtree/Clayton.png', 'IsExpand': 'true',
                    'RatingColor': '#93B85A', 'ReportingPerson': 4
            },
            {
                'Id': 20, 'Name': 'Thomas Hardy', 'Designation': 'Senior S/w Engg',
                'ImageUrl': '/app/content/images/radialtree/image57.png', 'IsExpand': 'false',
            ...
            },
            {
                ...
                'ImageUrl': '/app/content/images/radialtree/image51.png', 'IsExpand': 'false',
                'RatingColor': '#EBB92E', 'ReportingPerson': 6
            },
            {
                'Id': 23, 'Name': 'Diego Roel', 'Designation': 'Senior S/w Engg',
                'ImageUrl': '/app/content/images/radialtree/image55.png', 'IsExpand': 'false',
            ...
            },
            {
                    ...
                    'ImageUrl': '/app/content/images/radialtree/image56.png', 'IsExpand': 'None',
                    'RatingColor': '#D46E89', 'ReportingPerson': 8
            },
            {
            ...
            },
            {
                    ...
                    'ImageUrl': '/app/content/images/radialtree/image57.png', 'IsExpand': 'None',
                    'RatingColor': '#D46E89', 'ReportingPerson': 14
            },
            {
                'Id': 31, 'Name': 'Karin Josephs', 'Designation': 'Senior S/w Engg',
                'ImageUrl': '/app/content/images/radialtree/image55.png', 'IsExpand': 'None',
                'RatingColor': '#D46E89', 'ReportingPerson': 14
            },
            {
                'Id': 32, 'Name': 'Ruby Anabela ', 'Designation': 'Senior S/w Engg',
                'ImageUrl': '/app/content/images/radialtree/Thomas.png', 'IsExpand': 'None',
                'RatingColor': '#D46E89', 'ReportingPerson': 16
            },
            {
                'Id': 33, 'Name': 'Pirkko King', 'Designation': 'Senior S/w Engg',
                'ImageUrl': '/app/content/images/radialtree/Robin.png', 'IsExpand': 'None',
                'RatingColor': '#D46E89', 'ReportingPerson': 17
            },
            {
                'Id': 34, 'Name': 'Karl Jablonski', 'Designation': 'Senior S/w Engg',
                'ImageUrl': '/app/content/images/radialtree/image53.png', 'IsExpand': 'None',
            ...
            },
            {
                    ...
                    'ImageUrl': '/app/content/images/radialtree/Clayton.png', 'IsExpand': 'false',
            ...
            },
            {
                ...
                'ImageUrl': '/app/content/images/radialtree/eric.PNG', 'IsExpand': 'None',
                'RatingColor': '#68C2DE', 'ReportingPerson': 43
            },
            {
                'Id': 51, 'Name': 'Jose Pavarotti', 'Designation': 'S/w Engg',
                'ImageUrl': '/app/content/images/radialtree/Maria.PNG', 'IsExpand': 'None',
                'RatingColor': '#D46E89', 'ReportingPerson': 43
            },
            {
                'Id': 52, 'Name': 'Palle Ibsen', 'Designation': 'S/w Engg',
                'ImageUrl': '/app/content/images/radialtree/image51.png', 'IsExpand': 'None',
            ...
            },
            {
                ...
                'ImageUrl': '/app/content/images/radialtree/image57.png', 'IsExpand': 'true',
            ...
            },
            {
                ...
                'ImageUrl': '/app/content/images/radialtree/John.png', 'IsExpand': 'true',
            ...
            },
            {
                ...
                'ImageUrl': '/app/content/images/radialtree/image51.png', 'IsExpand': 'true',
            ...
            },
            {
                ...
                'ImageUrl': '/app/content/images/radialtree/Paul.png', 'IsExpand': 'None',
            ...
            },
            {
                ...
                'ImageUrl': '/app/content/images/radialtree/eric.png', 'IsExpand': 'true',
