...
export const mapAppRoutes: Routes = [
    { path: 'default', component: MarkerComponent, data: { name: 'Default', location: 'app/components/map/marker.component' } },
...
@NgModule({
    ...
    declarations: [MarkerComponent, LabelComponent, SelectionComponent, FlightComponent, ZoomingComponent, HeatComponent,
        EJ_MAP_COMPONENTS
    ]
})
