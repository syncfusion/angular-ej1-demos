...
@gantt-chart-histobar-overallocate-bg-color: #A71717 ;
@gantt-chart-histobar-nonoverallocate-bg-color: #41843A ;
@gantt-chart-histocalender-color: #F46363;
@gantt-chart-histowork-label: #FFFFFF;
