...
@gantt-chart-histobar-overallocate-bg-color: #FFDEDE;
@gantt-chart-histobar-nonoverallocate-bg-color: #D4FFD0;
@gantt-chart-histocalender-color: #FFA3A3;
@gantt-chart-histowork-label: #282827;
...
@gantt-child-unschedule-task-bg-color: fadeout(@active-bg-stcolor,80%);
@gantt-manual-child-unschedule-task-bg-color: fadeout(@gantt-chart-manual-child-taskbar-color, 80%);
...
.e-pager .e-textbox-paging.e-pagercontainer .e-newrecord,.e-pager .e-textbox-paging.e-pagercontainer .e-firstpage,
.e-pager .e-textbox-paging.e-pagercontainer .e-lastpage,.e-pager .e-textbox-paging.e-pagercontainer .e-nextpage,
.e-pager .e-textbox-paging.e-pagercontainer .e-prevpage,.e-pager .e-textbox-paging.e-pagercontainer .e-firstpagedisabled,
.e-pager .e-textbox-paging.e-pagercontainer .e-lastpagedisabled,.e-pager .e-textbox-paging.e-pagercontainer .e-nextpagedisabled,
...
.e-pager .e-textbox-paging.e-pagercontainer .e-newrecord,.e-pager.e-rtl .e-textbox-paging.e-pagercontainer .e-newrecord{
	& when (@skin="office-365"){
		font-weight: bolder;
	}
}
...
.e-pager.e-rtl .e-textbox-paging.e-pagercontainer .e-newrecord,.e-pager.e-rtl .e-textbox-paging.e-pagercontainer .e-firstpage,
.e-pager.e-rtl .e-textbox-paging.e-pagercontainer .e-lastpage,.e-pager.e-rtl .e-textbox-paging.e-pagercontainer .e-nextpage,
.e-pager.e-rtl .e-textbox-paging.e-pagercontainer .e-prevpage,.e-pager.e-rtl .e-textbox-paging.e-pagercontainer .e-firstpagedisabled,
.e-pager.e-rtl .e-textbox-paging.e-pagercontainer .e-lastpagedisabled,.e-pager.e-rtl .e-textbox-paging.e-pagercontainer .e-nextpagedisabled,
...
.e-scroller.e-speed-scroll .e-content, .e-scroller.e-speed-scroll .e-content {
...
.e-datepicker.e-popup .e-header .e-prev.e-disable:not(:active):after, .e-datepicker.e-popup .e-header .e-next.e-disable:not(:active):after {
    & when (@skin="material") {
        background-color: transparent;
    }
}
...
.e-datetime-wrap.e-focus .e-in-wrap,.e-datetime-wrap.e-focus .e-in-wrap:hover {
    & when not (@skin= "material") {
        .focus-border-color();
    }
}
...
.e-daterangewidget.e-focus .e-in-wrap:hover, .e-daterangewidget .e-focus  .e-in-wrap:hover{
    .focus-border-color();
}
...
.e-pivotgrid .e-chkbox-wrap .e-chk-image.e-stop, .e-pivotgrid .e-chkbox-wrap .e-chk-image.e-checkmark,
.e-pivotschemadesigner .e-chkbox-wrap .e-chk-image.e-stop, .e-pivotschemadesigner .e-chkbox-wrap .e-chk-image.e-checkmark
{    
    & when (@skin= "material") {        
...
.e-pivotgrid .e-separateDiv {
  border: 1px solid @row-border-color !important;
  border-bottom: none !important;
  margin: 9px 0px;
...
.e-pivotgrid .e-memberAscendingIcon:hover {
  ...
  & when not (@skin = "material") and not (@skin = "office-365") {
       background-color: @pivot-selection-background;
  }
  & when (@skin = "office-365") {
       background-color: @theme-lighter;
  }
...
.e-pivotschemadesigner  .e-dialog .e-memberSearchPager,.e-pivotgrid .e-dialog .e-memberSearchPager,
.e-pivotschemadesigner  .e-dialog .e-memberDrillPager,.e-pivotgrid .e-dialog .e-memberDrillPager {
    margin-top:10px;
    margin-bottom:20px;
}
.e-pivotschemadesigner  .e-dialog .e-memberPager+div.e-dialogFooter,.e-pivotgrid .e-dialog .e-memberPager+div.e-dialogFooter,
.e-pivotschemadesigner  .e-dialog .e-memberSearchPager+div.e-dialogFooter,.e-pivotgrid .e-dialog .e-memberSearchPager+div.e-dialogFooter,
.e-pivotschemadesigner  .e-dialog .e-memberDrillPager+div.e-dialogFooter,.e-pivotgrid .e-dialog .e-memberDrillPager+div.e-dialogFooter  {
        & when not (@skin = "material") and not (@skin = "office-365") {
...
.e-pivotgrid .e-advancedFilterDlg .e-memberSearchPager,.e-pivotschemadesigner .e-advancedFilterDlg .e-memberSearchPager,
.e-pivotgrid .e-advancedFilterDlg .e-memberDrillPager,.e-pivotschemadesigner .e-advancedFilterDlg .e-memberDrillPager{
    margin-left:12px;
    margin-right:12px;
}
...
.e-pivotschemadesigner .e-dialog .e-memberCurrentSearchPage,.e-pivotgrid .e-dialog .e-memberCurrentSearchPage,
.e-pivotschemadesigner .e-dialog .e-memberCurrentDrillPage,.e-pivotgrid .e-dialog .e-memberCurrentDrillPage{
    margin-left:8px;
    margin-right:6px;
    outline:none;
    text-indent:3px;
...
.e-pivotschemadesigner .e-dialog .memberSearchPageCount,.e-pivotgrid .e-dialog .memberSearchPageCount,
.e-pivotschemadesigner .e-dialog .memberDrillPageCount,.e-pivotgrid .e-dialog .memberDrillPageCount
{
    margin-right:8px;
}
.e-pivotschemadesigner .e-dialog .e-memberPager+div,.e-pivotgrid .e-dialog .e-memberPager+div,
.e-pivotschemadesigner .e-dialog .e-memberSearchPager+div,.e-pivotgrid .e-dialog .e-memberSearchPager+div,
.e-pivotschemadesigner .e-dialog .e-memberDrillPager+div,.e-pivotgrid .e-dialog .e-memberDrillPager+div{
...
.e-pivotgrid .e-dialog .e-memberSearchPager+div .e-btn.e-dialogOKBtn, e-pivotgrid .e-dialog .e-memberSearchPager+div .e-btn.e-dialogCancelBtn,.e-pivotschemadesigner .e-dialog .e-memberSearchPager+div .e-btn.e-dialogOKBtn, .e-pivotschemadesigner .e-dialog .e-memberSearchPager+div .e-btn.e-dialogCancelBtn,
.e-pivotgrid .e-dialog .e-memberDrillPager+div .e-btn.e-dialogOKBtn, e-pivotgrid .e-dialog .e-memberDrillPager+div .e-btn.e-dialogCancelBtn,.e-pivotschemadesigner .e-dialog .e-memberDrillPager+div .e-btn.e-dialogOKBtn, .e-pivotschemadesigner .e-dialog .e-memberDrillPager+div .e-btn.e-dialogCancelBtn{
  & when (@skin = "material") {
      margin-top:0px;
      margin-bottom:0px;
   }
...
.e-pivotschemadesigner .e-dialog .e-memberSearchPager+div .e-btn, .e-pivotschemadesigner .e-dialog .e-memberSearchPager+div .e-btn,.e-pivotgrid .e-dialog .e-memberSearchPager+div .e-btn, .e-pivotgrid .e-dialog .e-memberSearchPager+div .e-btn,
.e-pivotschemadesigner .e-dialog .e-memberDrillPager+div .e-btn, .e-pivotschemadesigner .e-dialog .e-memberDrillPager+div .e-btn,.e-pivotgrid .e-dialog .e-memberDrillPager+div .e-btn, .e-pivotgrid .e-dialog .e-memberDrillPager+div .e-btn{
  & when (@skin = "material") {
      margin-top:0px;
      margin-bottom:0px;
   }
...
.e-pivotschemadesigner .e-dialog .e-memberSearchPager+div .e-btn.e-dialogOKBtn,.e-pivotgrid .e-dialog .e-memberSearchPager+div .e-btn.e-dialogOKBtn,
.e-pivotschemadesigner .e-dialog .e-memberDrillPager+div .e-btn.e-dialogOKBtn,.e-pivotgrid .e-dialog .e-memberDrillPager+div .e-btn.e-dialogOKBtn{
        & when (@skin = "office-365") {
...
.e-pivotschemadesigner.e-rtl .e-dialog .e-memberSearchPager+div .e-btn.e-dialogOKBtn,.e-pivotgrid.e-rtl .e-dialog .e-memberSearchPager+div .e-btn.e-dialogOKBtn,
.e-pivotschemadesigner.e-rtl .e-dialog .e-memberDrillPager+div .e-btn.e-dialogOKBtn,.e-pivotgrid.e-rtl .e-dialog .e-memberDrillPager+div .e-btn.e-dialogOKBtn{
            & when (@skin = "office-365") {
...
.e-pivotgrid .e-dialog .e-memberSearchPager .e-memberCurrentPage:hover,.e-pivotschemadesigner .e-dialog .e-memberSearchPager .e-memberCurrentPage:hover,
.e-pivotgrid .e-dialog .e-memberDrillPager .e-memberCurrentPage:hover,.e-pivotschemadesigner .e-dialog .e-memberDrillPager .e-memberCurrentPage:hover{
          & when (@skin = "material") {
...
.e-pivotschemadesigner .e-dialog .e-memberSearchPager .e-memberCurrentPage:active,.e-pivotschemadesigner .e-dialog .e-memberSearchPager .e-memberCurrentPage:focus,.e-pivotgrid .e-dialog .e-memberSearchPager .e-memberCurrentPage:active,.e-pivotgrid .e-dialog .e-memberSearchPager .e-memberCurrentPage:focus,
.e-pivotschemadesigner .e-dialog .e-memberDrillPager .e-memberCurrentPage:active,.e-pivotschemadesigner .e-dialog .e-memberDrillPager .e-memberCurrentPage:focus,.e-pivotgrid .e-dialog .e-memberDrillPager .e-memberCurrentPage:active,.e-pivotgrid .e-dialog .e-memberDrillPager .e-memberCurrentPage:focus{
          & when (@skin = "material") {
...
.e-pivotgrid .e-dialog .e-memberSearchPager .e-memberCurrentPage,.e-pivotschemadesigner .e-dialog .e-memberSearchPager .e-memberCurrentPage,
.e-pivotgrid .e-dialog .e-memberDrillPager .e-memberCurrentPage,.e-pivotschemadesigner .e-dialog .e-memberDrillPager .e-memberCurrentPage{
      & when (@skin = "material") {
...
.e-pivotgrid .e-dialog .e-memberSearchPager,.e-pivotschemadesigner .e-dialog .e-memberSearchPager,
.e-pivotgrid .e-dialog .e-memberDrillPager,.e-pivotschemadesigner .e-dialog .e-memberDrillPager{
   & when (@skin = "office-365") {
    margin-top:0px;
   }
}
...
.e-pivotschemadesigner .e-dialog .e-memberSearchPager+div .e-btn.e-dialogOKBtn,.e-pivotschemadesigner .e-dialog .e-memberSearchPager+div .e-btn.e-dialogCancelBtn,.e-pivotschemadesigner.e-rtl .e-dialog .e-memberSearchPager+div .e-btn.e-dialogOKBtn,.e-pivotschemadesigner.e-rtl .e-dialog .e-memberSearchPager+div .e-btn.e-dialogCancelBtn,.e-pivotgrid .e-dialog .e-memberSearchPager+div .e-btn.e-dialogOKBtn,.e-pivotgrid .e-dialog .e-memberSearchPager+div .e-btn.e-dialogCancelBtn,.e-pivotgrid.e-rtl .e-dialog .e-memberSearchPager+div .e-btn.e-dialogOKBtn,.e-pivotgrid.e-rtl .e-dialog .e-memberSearchPager+div .e-btn.e-dialogCancelBtn,
.e-pivotschemadesigner .e-dialog .e-memberDrillPager+div .e-btn.e-dialogOKBtn,.e-pivotschemadesigner .e-dialog .e-memberDrillPager+div .e-btn.e-dialogCancelBtn,.e-pivotschemadesigner.e-rtl .e-dialog .e-memberDrillPager+div .e-btn.e-dialogOKBtn,.e-pivotschemadesigner.e-rtl .e-dialog .e-memberDrillPager+div .e-btn.e-dialogCancelBtn,.e-pivotgrid .e-dialog .e-memberDrillPager+div .e-btn.e-dialogOKBtn,.e-pivotgrid .e-dialog .e-memberDrillPager+div .e-btn.e-dialogCancelBtn,.e-pivotgrid.e-rtl .e-dialog .e-memberDrillPager+div .e-btn.e-dialogOKBtn,.e-pivotgrid.e-rtl .e-dialog .e-memberDrillPager+div .e-btn.e-dialogCancelBtn
{
        & when (@skin = "office-365") {
      margin-bottom:0px !important;
      }
...
.e-pivotclient .e-box,.e-pivotclient button.e-btn,.e-pivotclient input.e-btn,.e-pivotclient input.e-input,.e-pivotclient input[type="text"].e-input,
.e-pivotclient .e-input.e-placeholder,.e-pivotclient  input.e-input,.e-pivotclient .e-js.e-lv.e-js .e-header.e-box,.e-pivotclient .e-textbox, .e-textarea
{
...
.e-pivotclient .e-memberAscendingIcon:hover {
  background-color: @oclient-icons-hover-bg;
  cursor: pointer;
}
...
color:@oclient-treeview-text-hover;
 ...
 .e-pivotclient .e-chkbox-wrap .e-chk-image.e-stop, .e-pivotclient .e-chkbox-wrap .e-chk-image.e-checkmark
{    
    & when (@skin= "material") {        
       color:@accent-font-color !important;
       background-color: @accent-color !important;
...
.e-pivotclient input.e-memberCurrentPage,.e-pivotclient input.e-memberCurrentSearchPage,.e-pivotclient input.e-memberCurrentDrillPage {
    & when (@skin = "office-365"){
...
.e-pivotclient .e-toolbar .e-reportCol, .e-pivotclient .e-toolbar .e-reportCol.e-hover, .e-pivotclient .e-collectionli, .e-pivotclient .e-collectionli.e-hover, .e-pivotclient .e-reportli, .e-pivotclient .e-reportli.e-hover{
   & when (@skin = "material") {
...
.e-pivotclient .e-toolbar>.e-horizontal>.e-reportCol.e-active,.e-pivotclient .e-toolbar>.e-horizontal>.e-reportCol.e-active>.reportList, .e-pivotclient .e-toolbar>.e-horizontal>.e-collectionli.e-active,.e-pivotclient .e-toolbar>.e-horizontal>.e-collectionli.e-active>.e-collectionlist{
   & when (@skin = "material") {
    background:none;
   }
}
.e-pivotclient .e-toolbar>.e-horizontal>.e-reportCol.e-active:after, .e-pivotclient .e-toolbar>.e-horizontal>.e-collectionli.e-active:after, .e-pivotclient .e-toolbar>.e-horizontal>.e-reportli.e-active:after{
   & when (@skin = "material") {
    animation: none;
   }
}
...
.e-pivotclient .e-dialog .e-memberPager+div, .e-pivotclient .e-dialog .e-memberSearchPager+div, .e-pivotclient .e-dialog .e-memberDrillPager+div{
  & when (@skin = "material") {
      margin-top:0px !important;
      margin-bottom:20px !important;
   }
...
.e-pivotclient .e-pivotschemadesigner .e-dialog .e-memberPager+div .e-btn.e-dialogOKBtn, .e-pivotclient .e-pivotschemadesigner .e-dialog .e-memberSearchPager+div .e-btn.e-dialogOKBtn, .e-pivotclient .e-pivotschemadesigner .e-dialog .e-memberDrillPager+div .e-btn.e-dialogOKBtn{
        & when (@skin = "office-365") {
      margin-left:60px !important;
      }
}
.e-pivotclient.e-rtl .e-pivotschemadesigner .e-dialog .e-memberPager+div .e-btn.e-dialogOKBtn, .e-pivotclient.e-rtl .e-pivotschemadesigner .e-dialog .e-memberSearchPager+div .e-btn.e-dialogOKBtn, .e-pivotclient.e-rtl .e-pivotschemadesigner .e-dialog .e-memberDrillPager+div .e-btn.e-dialogOKBtn{
            & when (@skin = "office-365") {
      margin-right:60px !important;
      }
}
.e-pivotclient .e-dialog .e-memberPager .e-memberCurrentPage:hover,.e-pivotclient .e-dialog .e-memberSearchPager .e-memberCurrentSearchPage:hover,.e-pivotclient .e-dialog .e-memberDrillPager .e-memberCurrentDrillPage:hover{
          & when (@skin = "material") {
          border-color: fade(#000000, 26%);
      }
            & when (@skin = "office-365") {
...
.e-pivotclient .e-dialog .e-memberSearchPager .e-memberCurrentSearchPage:active,.e-pivotclient .e-dialog .e-memberSearchPager .e-memberCurrentSearchPage:focus,
.e-pivotclient .e-dialog .e-memberDrillPager .e-memberCurrentDrillPage:active,.e-pivotclient .e-dialog .e-memberDrillPager .e-memberCurrentDrillPage:focus{
          & when (@skin = "material") {
          border-color: fade(#000000, 54%);
      }
            & when (@skin = "office-365") {
...
.e-pivotclient .e-dialog .e-memberPager .e-memberCurrentPage, .e-pivotclient .e-dialog .e-memberSearchPager .e-memberCurrentSearchPage, .e-pivotclient .e-dialog .e-memberDrillPager .e-memberCurrentDrillPage{
      & when (@skin = "material") {
          color: fade(#000000, 87%);
              font-family:'Roboto',Segoe UI;
    font-size:12px;
...
.e-pivotclient .e-pivotschemadesigner .e-dialog .e-memberPager, .e-pivotclient .e-pivotschemadesigner .e-dialog .e-memberSearchPager, .e-pivotclient .e-pivotschemadesigner .e-dialog .e-memberDrillPager{
   & when (@skin = "office-365") {
    margin-top:0px;
   }
}
...
.e-pivotclient .e-firstPage, .e-pivotclient .e-prevPage, .e-pivotclient .e-nextPage, .e-pivotclient .e-lastPage,.e-memberCurrentSearchPage,.e-memberSearchPageCount,
.e-pivotclient .e-firstPage, .e-pivotclient .e-prevPage, .e-pivotclient .e-nextPage, .e-pivotclient .e-lastPage,.e-memberCurrentDrillPage,.e-memberDrillPageCount {
   & when (@skin="material"), (@skin="office-365") {
    vertical-align:middle;
  }
}
...
.e-pivotchart .e-chartTypesImg, .e-pivotchart .e-chartTypesImg:hover, .e-pivotchart .e-toolTipImg, .e-pivotchart .e-toolTipImg:hover, .e-pivotchart .e-chart3DImg, .e-pivotchart .e-chart3DImg:hover, .e-pivotchart .e-exportImg, .e-pivotchart .e-exportImg:hover, .e-pivotchart .e-chartTypesImg:hover, .e-pivotchart .e-legend, .e-pivotchart .e-legend:hover, .e-pivotchart .e-zooming, .e-pivotchart .e-zooming:hover, .e-pivotchart .e-smartLabels, .e-pivotchart .e-smartLabels:hover, .e-pivotchart .e-interaction, .e-pivotchart .e-interaction:hover, .e-pivotchart .e-icon-xAxis-title:hover, .e-pivotchart .e-icon-yAxis-title:hover, .e-pivotchart .e-icon-xAxis-title, .e-pivotchart .e-icon-yAxis-title{
 ...
 .e-pivotchart .e-chartTypesImg, .e-pivotchart .e-toolTipImg, .e-pivotchart .e-chart3DImg, .e-pivotchart .e-exportImg, .e-pivotchart .e-chartTypesImg,  .e-pivotchart .e-legend, .e-pivotchart .e-zooming, .e-pivotchart .e-smartLabels, .e-pivotchart .e-interaction, .e-pivotchart .e-icon-xAxis-title, .e-pivotchart .e-icon-yAxis-title{     
    overflow:visible !important;
    color:@oclient-icons-color;
    text-indent:-3px;
    }
...
.e-reportviewer-toolbarcontainer,
 ...
 .e-reportviewer-toolbarli.e-reportviewer-ejdropdownlist .e-rptviewer-drpdown .e-in-wrap.e-box {
    & when (@skin= "material") {
        border-style: none;
    }
}
 ...
 .e-reportviewer-toolbarli.e-reportviewer-ejdropdownlist .e-rptviewer-drpdown .e-in-wrap.e-box .e-select {
    & when (@skin= "material") {
        background-color: transparent;
    }
}
...
.e-treegrid .e-borderbox {
    ...
    & when not (@skin= "material") and not (@skin="office-365"){
        border-bottom-color: @scroll-handle-color;
    }
}
...
.e-ribbon.e-responsive .e-ribresmenu a,.e-ribbon.e-responsive .e-responsivetabli,.e-ribbon.e-responsive .e-rescontent .e-responsivetabli:hover{
     & when (@skin= "material") {
        /*material*/
     background: @grey-200;
    }
...
.e-kanban.e-rtl .e-headercontent, .e-kanban.e-rtl .e-columnrow td.e-dropping:first-child, .e-kanban .e-kanbancontent .e-rowcell.e-dragged {
...
.e-kanban .e-kanbandialog .e-kanban-editdiv .e-save, .e-kanban .e-kanbandialog .e-kanban-editdiv .e-cancel, .e-kanban .e-externalform .e-save, .e-kanban .e-externalform .e-cancel,.e-kbnadapt-editdlg .e-save,.e-kbnadapt-editdlg .e-cancel,.e-kanbanfilter-window .e-clearfilter{
   & when (@skin= "material") {
      /*material*/
    background: @content-bg-color;
    color: @accent-color;
...
.e-media-player .e-media-playlist-container .e-listbox .e-select {
    /*background: @active-bg-stcolor !important;*/
}
...
.e-ganttchart .e-ganttoverallocate{
       background-color:@gantt-chart-histobar-overallocate-bg-color;
}
.e-ganttchart .e-ganttnonoverallocate{
       background-color:@gantt-chart-histobar-nonoverallocate-bg-color;
}
.e-ganttchart .e-gantthistocalender{
       border-color: @gantt-chart-histocalender-color;
}
.e-ganttchart .e-gantthistoworklabel{
        color: @gantt-chart-histowork-label;
}
...
.e-ganttchart .e-gantt-childtaskbar.e-gantt-unscheduletaskbar {
    background-color:@gantt-child-task-bg-color;    
    background: linear-gradient(to right, @gantt-child-unschedule-task-bg-color, @gantt-child-progress-bg-color 30%, @gantt-child-progress-bg-color 70%, @gantt-child-progress-bg-color 70%, @gantt-child-unschedule-task-bg-color 100%);
    -ms-filter:"progid:DXImageTransform.Microsoft.Alpha(Opacity=40)";
}
.e-ganttchart .e-manualchildtaskbar.e-gantt-unscheduletaskbar-left {
    ...
    background: none;
    & when (@skin= "office-365") {
        border-color:@gantt-chart-manual-child-progressbar-stbg-color;
    }
}
...
.e-ganttchart .e-manualchildtaskbar.e-gantt-unscheduletaskbar {
    background-color:@gantt-chart-manual-child-taskbar-color;
    background: linear-gradient(to right, @gantt-manual-child-unschedule-task-bg-color, @gantt-chart-manual-child-progressbar-stbg-color  30%, @gantt-chart-manual-child-progressbar-stbg-color 70%, @gantt-chart-manual-child-progressbar-stbg-color 70%, @gantt-manual-child-unschedule-task-bg-color 100%);
    -ms-filter:"progid:DXImageTransform.Microsoft.Alpha(Opacity=40)";
}
.e-ganttchart .e-milestone-top.e-unscheduletaskbar{    
    border-bottom-color:@gantt-parent-task-bg-color;   
}

.e-ganttchart .e-milestone-bottom.e-unscheduletaskbar {
    border-top-color:@gantt-parent-task-bg-color;
}
