...
export declare class ReportViewerComponent extends EJComponents<any, any> {
    ...
    exportProgressChanged_output: EventEmitter<{}>;
    printProgressChanged_output: EventEmitter<{}>;
    exportItemClick_output: EventEmitter<{}>;
    toolBarItemClick_output: EventEmitter<{}>;
    hyperlink_output: EventEmitter<{}>;
    reportPrint_output: EventEmitter<{}>;
